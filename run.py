...
def main():
    ...
    parser.add_argument('command', choices=('worker', 'web', 'drafts', 'filing', 'filing-maintenance', 'retention', 'doctor', 'status', 'sieve', 'decisions', 'notify', 'subscriptions', 'subscription-actions', 'decision-suggestions', 'decision-actions'))
