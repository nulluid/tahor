...
def main():
    ...
    parser.add_argument('command', choices=('worker', 'web', 'drafts', 'filing', 'retention', 'doctor', 'status', 'sieve', 'decisions', 'notify', 'subscriptions', 'subscription-actions'))
