...
section:has(#reply-rules) { margin-top: 0; padding-top: 0; border-top: 0; }
        ...
        for page, filename, height in [('index', 'decisions', 1900), ('unsubscribe', 'subscriptions', 1080), ('settings', 'settings', settings_height), ('reply-rules', 'reply-rules', 1000), ('status', 'status', 850)]:
