...
class AppTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.saved = {key: sys.modules.pop(key, None) for key in ('config', 'mailbox_settings', 'tahor_db', 'apply_decisions', 'generate_sieve', 'runtime_status', 'reply_rules', 'vendor_inventory', 'vendor_suggestions')}
